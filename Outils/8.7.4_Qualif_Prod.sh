#!/bin/bash
#
# modifie l'environnement du courrielleur 8.7.4 de Qualif vers Prod

PS3="Modifier l'environnement du dépôt courrielleur de Qualif vers Prod ?"
...
source $rep/urls-Prod.txt


# chemin courrielleur
source $rep/modifUrls.sh

ModifieUrls chemin urls_QUALIF urls_Prod
