#!/bin/bash
#
# modifie l'environnement du courrielleur 8.7.4 de Qualif vers Dev

PS3="Modifier l'environnement du dépôt courrielleur de Qualif vers Dev ?"
...
ModifieUrls chemin urls_QUALIF urls_DEV
